...
//  console.log('begin to invoke the real http method');
...
/*    var postData = querystring.stringify({
  ...
  var postData = this.target.http_params;
  if(this.target.method == 'post'){
      //this.request.write(this.target.http_params);
    if(postData){
      this.request.write(postData);
    }
//      console.log(postData);
//      console.log(this.request);
//      console.log(this.target.http_params);
  }
  this.request.end();
};
